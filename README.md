...
2. Cài dependencies:
    # Cài toàn bộ dependencies cơ bản
    npm install
    # hoặc yarn install

    # Cài thư viện HTTP client
    npm install axios

    # Cài MSAL để xác thực Azure AD
    npm install @azure/msal-browser @azure/msal-react

    # Cài thư viện OLAP demo (tuỳ chọn)
    npm install react-pivottable plotly.js
...
3. Tạo file .env ở root với nội dung:
    ...
    REACT_APP_DATASET_ID = your-dataset-id
    REACT_APP_TABLE_NAME = your-table-name
